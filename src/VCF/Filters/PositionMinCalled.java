...
/**
 * Filters a position based on a minimum number of called genotypes
 * @author Daniel Money
 * @version 1.2.2
 */
public class PositionMinCalled extends PositionFilter
{
     ...
     */
    public PositionMinCalled(int minCalled, int minDepth)
    {
     ...
     */
    public PositionMinCalled(HierarchicalConfiguration<ImmutableNode> params)
    {
    ...
    {        
        ...
        ImmutableNode config = new ImmutableNode.Builder().name("filter")
                .addChild(Ithreshold)
                .addChild(Imindepth)
                .addAttribute("name", "PositionMinCalled")
                .create();
    ...
    {
        return "PositionMinCall(" + minCalled + ")";
    }
